...
namespace Utilities.Preconditions
{
    public class Preconditions
    {
        ...
        public static void CheckPositiveInt(int value)
        {
            CheckPositiveInt(value, null);
        }

        public static void CheckPositiveInt(int value, string message)
        {
            if (value > 0)
            {
                return;
            ...
            throw message == null ? new ArgumentOutOfRangeException() : new ArgumentOutOfRangeException(message);
        }
    }
}