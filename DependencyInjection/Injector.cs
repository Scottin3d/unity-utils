...
namespace Utilities.DependencyInjection {
    ...
    public class Injector : Singleton<Injector> {
        ...
        /// <summary>
        /// Validates the dependencies of the MonoBehaviour scripts in the scene.
        /// It checks for missing dependencies that are marked with the [Inject] attribute.
        /// If any invalid dependencies are found, it logs an error message.
        /// </summary>
        ...
        /// <summary>
        /// Clears all dependencies in the MonoBehaviour instances found in the scene.
        /// </summary>
